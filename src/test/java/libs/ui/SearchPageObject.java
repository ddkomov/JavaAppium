...
public class SearchPageObject extends MainPageObject {
    ...
    private static final String
            ...
            SEARCH_ONBOARDING_SKIP_BUTTON = "org.wikipedia:id/fragment_onboarding_skip_button";
    ...
    {
        waitForElementAndClick(By.xpath(SEARCH_CANCEL_BUTTON), "Cannot find and click search cancel button.", 5);
    ...
    {
        this.waitForElementAndClick(By.id(SEARCH_ONBOARDING_SKIP_BUTTON),"Cannot find onboarding skip button", 10);
    }
}
